...
<template>
  <div class="user-container">
    ...
    <div class="table-container">
      ...
      >
        <el-table-column type="selection" width="55" align="center"></el-table-column> <!-- 新增选择列 -->
        <el-table-column
          type="index"
          label="序号"
          width="80"
    ...
    >
      <div class="dialog-content">
        ...
        >
          ...
          <el-form-item label="联系电话">
            ...
            <!-- 新增提示文本 -->
            <div class="phone-tips" v-if="phoneTips">{{ phoneTips }}</div>
        </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button @click="resetForm" class="reset-btn">重 置</el-button> <!-- 新增重置按钮 -->
